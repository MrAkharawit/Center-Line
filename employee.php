                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-dark bold uppercase"> รายการพนักงาน </span>
                                    </div>
                                </div>
                                <div class="portlet-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="btn-group">
                                                <a href="addEmployee.php" class="btn green-meadow"> เพิ่มพนักงาน
                                    ...
                                    <div class="portlet box green">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                <i class="fa fa-comments"></i> รายการพนักงาน </div>
                                            <div class="tools">
